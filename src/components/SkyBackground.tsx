 ...
 *  全画面ペイントの回数は変わらない。
 *
 *  間隔を広げるほど 1 回あたりの色の跳びが大きくなり、日の出と日没の前後のように色が速く動く帯では
 *  段差として見えてしまう。おおよそ 2 フレームに 1 回 = 30 回/秒 を上限にして、以前の 2 分量子化が
 *  じどうかいてん中に出していた塗り直し頻度に揃え、色は連続に見えるまま速さとの切り離しだけを残す。 */
const SKY_REPAINT_MIN_INTERVAL_MS = 32;
