# Contributing to Futatoki the Learning Clock App
...
Futatoki the Learning Clock App was built to help young children learn time. Keep in mind:
...
The names "Futatoki" / "Futatoki the Learning Clock App" / "Futatoki the Learning Clock" / "Futatoki the Clock" and the project's branding are not part of the MIT-licensed code — see [NOTICE](./NOTICE) for details.
