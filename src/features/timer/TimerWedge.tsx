...
import { CENTER, timerWedgeRadius, pieSectorPath } from "../../components/clockface-layers/geometry";
import { lerpColor } from "../../lib/color";

/**
 * タイマー盤の扇レイヤー。timer 盤の中心から、長針 (分針) より気持ち短い半径まで扇 (pie) で塗る (扇の弧から
 * 針先が少し覗いて「今ここ」が読める)。半径は geometry.timerWedgeRadius (長針長基準) を使うので、detailMode ×
 * colorMode で針長が変わっても自動で追従する。開始点線 (TimerStartLine) の外端も同じ半径を共有する。
 * ClockFace の children として BaseFace と FaceDetail の間に
